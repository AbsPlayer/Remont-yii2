            ...
            <table cellpadding="0" cellspacing="0" border="0" height="100%">
                ...
                <tr>
                    <td valign="top"  height="100%" width="245" background="../images/bgleft.gif" style="background-repeat:repeat-y;">
                        <table cellpadding="0" cellspacing="0" border="0" height="100%">
                            <tr>
                                <td background="../images/cap01.gif" width="245" height="57" align="center" class="cap1">Меню</td>
                            </tr>
                            <tr>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td align='right' style="padding-left:60; padding-top:5">
                                                <a href='<?= Url::to(['/logout'])?>' title='Выход'><button>Выход</button></a>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                ...
                <tr>
                    <td colspan="2" width="780" height="28" background="../images/bgmenu.gif" align="center" class="menu"><a href='<?= Url::to('/admin') ?>' title='На главную страницу сайта' class="menu">Главная</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="<?= Url::to(['/admin/production']) ?>" title='Продукция' class="menu">Продукция</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="<?= Url::to(['/admin/contact']) ?>" title='Контакты' class="menu">Контакты</a></td>
                </tr>
                <tr>
